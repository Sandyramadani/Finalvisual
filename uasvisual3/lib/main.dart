...
class _LoginState extends State<Login> {
 ...
 login() async {
   final response = await http.post("http://finaluas.000webhostapp.com/Pegawai/login.php",body: {
     "email": email, 
     "password": password
     });
...
class _RegisterState extends State<Register> {
 ...
 save() async {
   final response = await http.post("http://finaluas.000webhostapp.com/Pegawai/register.php",
...
class _MainMenuState extends State<MainMenu> {
  ...
  Future<List> getData() async {
    final response = await http.get("http://finaluas.000webhostapp.com/Pegawai/getPegawai.php");
